...
package com.ewinz.mockchecker.databinding;
...
import com.ewinz.mockchecker.R;
...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull FrameLayout rootView, @NonNull ImageView backgroundImage,
      @NonNull TextView headerText, @NonNull Button refreshButton, @NonNull TextView textView) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((FrameLayout) rootView, backgroundImage, headerText,
